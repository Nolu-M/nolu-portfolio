    ...
    return (
        <section id='about'>
            <div className='container mx-auto'>
                <div className=''>
                    <div className=''>
                        <h3 className='mb-8 pt-8 text-center pb-8 text-5xl text-center text-purple font-primary'>ABOUT ME</h3>
                    ...
                    <h3 className='mb-8 mt-8 text-center text-4xl font-medium text-[#6d4d6e]'>Technologies</h3>
                    <div className='pb-8 pt-8 grid grid-cols-4'>
                        ...
                        <img className="w-24" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/flask/flask-original-wordmark.svg" />
