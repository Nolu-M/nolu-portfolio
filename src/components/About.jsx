    ...
    return (
        <section className=''>
            <div className='container mx-auto'>
                <div className=''>
                    <div className=''>
                        <h3 className='mb-8 pt-8 text-center text-2xl font-medium text-white'>About me</h3>
                        <p className='text-lg leading-7 text-center text-white'>I am Nolubabalo Maxazana, a self-driven software developer passionate about both frontend and full-stack development.
                    ...
                    <h3 className='mb-8 mt-8 text-center text-2xl font-medium text-white'>Technologies</h3>
